...
> = {
  critical: { bg: "rgba(211,64,46,0.15)", text: "#D3402E", labelKey: "alert.impact.critical", shortKey: "alert.impact.short.critical" },
  major: { bg: "rgba(192,85,43,0.15)", text: "#C0552B", labelKey: "alert.impact.major", shortKey: "alert.impact.short.major" },
  moderate: { bg: "rgba(224,168,46,0.15)", text: "#E0A82E", labelKey: "alert.impact.moderate", shortKey: "alert.impact.short.moderate" },
  minor: { bg: "rgba(31,138,120,0.15)", text: "#1F8A78", labelKey: "alert.impact.minor", shortKey: "alert.impact.short.minor" },
};
