        ...
        return (
          ...
          >
            <button
              ...
              className="w-full flex items-center gap-3 px-3.5 py-2.5 text-left hover:bg-[rgba(255,255,255,0.03)] transition-colors"
            >
              <div
              ...
              <div className="flex items-center gap-1 text-[10.5px] text-ink-3 min-w-[80px] justify-end">
            ...
            {isOpen && (
              <div className="border-t border-border p-3.5 bg-[rgba(255,255,255,0.02)] space-y-3">
                ...
                <div className="text-[10px] text-ink-4">
                  ...
                  Test logins: investor+{f.slug}@navuuna.dev · investor-lead+{f.slug}@navuuna.dev
                </div>
              </div>
            )}
          </div>
