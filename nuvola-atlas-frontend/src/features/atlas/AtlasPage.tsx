...
import ScorecardPanel from "@/features/scorecard/components/ScorecardPanel";
import ChatPanel from "@/features/assistant/components/ChatPanel";
import CountyBanner from "@/features/vitality/components/CountyBanner";

// mapbox-gl is ~1.8 MB; defer it so the Atlas shell paints first.
const AtlasMap = lazy(() => import("@/features/atlas/components/AtlasMap"));
