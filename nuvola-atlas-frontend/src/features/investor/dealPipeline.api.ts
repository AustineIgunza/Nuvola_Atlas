...
const SEED_BY_FIRM: Record<string, Deal[]> = {
  ...
  "firm-andela": [
    ...
    },
    {
      ...
      thesis: "Growth-corridor thesis. Highest road-density pillar in East Nairobi.",
    ...
    },
    {
      ...
      thesis: "Closed Q2 · projected 22% IRR · monitored via composite score",
  ...
  "firm-gcf": [
    ...
    },
    {
      ...
      thesis: "Peri-urban wildlife corridor mandate, sited off the road-density read.",
    ...
    },
    {
      ...
      thesis: "Green-bond umbrella. Strong water & sanitation and road-density read.",
    ...
    },
    {
      ...
      amount: "KES 210M",
      owner: "James Mwangi",
      nextStep: "Passed — water & sanitation pillar below sovereign threshold",
      nextStepAt: "2026-06-15T00:00:00Z",
      thesis:
        "Passed after the water & sanitation pillar dropped in Q2. Revisit if the trend reverses.",
