...
export const ALERTS: AlertItem[] = [
  ...
  {
    id: "a13", severity: "medium", kind: "infra", title: "Roysambu microgrid battery bank delivery slipped", body: "The 420 kWh battery bank for the Roysambu Solar Microgrid has slipped from January to August delivery on the manufacturer's schedule. Panel array installation is complete; site remains ready for the bank on arrival.", zoneId: "roysambu", createdAt: "2026-05-11T09:00:00Z", read: false,
    affectedInfra: ["Roysambu Solar Microgrid", "Ward-scale islanding capability", "Backup for essential services"],
    recommendedActions: [
  ...
  {
    id: "a14", severity: "high", kind: "infra", title: "Thika Road copper-wiring theft cluster", body: "14 reported incidents of copper-wiring theft along the Thika Road Smart Lighting corridor between February and May 2026 have driven a 12% material wastage rate. Wiring speed is now gated by overnight security, not by crew availability.", zoneId: "kasarani", createdAt: "2026-05-16T13:15:00Z", read: false,
    affectedInfra: ["Thika Road Smart Lighting", "Un-energized poles (620 units)", "Corridor 5 in the safety-corridor mapping"],
    recommendedActions: [
  ...
  {
    id: "a15", severity: "low", kind: "infra", title: "Makadara AMI phase 2 closed out", body: "Makadara Smart Grid Pilot phase 2 installation closed out on schedule with 4,650 meters live across the ward. Non-technical loss detection has improved 34% versus baseline in the phase-1 zones — the pilot is now the reference deployment for county-wide smart-grid extension.", zoneId: "makadara", createdAt: "2026-05-08T10:30:00Z", read: true,
    affectedInfra: ["Makadara Smart Grid Pilot", "AMI meter fleet (4,650 units)", "Feeder head-end telemetry"],
    recommendedActions: [
  ...
  {
    id: "a16", severity: "medium", kind: "infra", title: "Eastleigh fibre nightwork incident", body: "A fibre-blowing crew reported a tool-theft incident and one case of harassment during nightwork on the Eastleigh Fibre Backbone. Delivery pace along the corridor has dropped to roughly 60% of plan.", zoneId: "kamukunji", createdAt: "2026-05-15T22:40:00Z", read: false,
    affectedInfra: ["Eastleigh Fibre Backbone", "Corridor 3 in the safety-corridor mapping", "Fibre-blowing crew safety"],
    recommendedActions: [
  ...
  {
    id: "a17", severity: "low", kind: "infra", title: "Ruaraka Bypass base course ahead of plan", body: "Base and binder course works on the Ruaraka Bypass Rehabilitation are running two weeks ahead of the January schedule. Asphalt overlay is on track for May 2026 and the July handover window looks solid.", zoneId: "ruaraka", createdAt: "2026-05-06T08:30:00Z", read: true,
  ...
  {
    id: "a18", severity: "low", kind: "infra", title: "Dagoretti North fibre blowing commenced", body: "Fibre-blowing phase on the Dagoretti North Fibre Ring commenced on schedule. Six independent nodes with dual-path redundancy remain on track for June 2026 activation.", zoneId: "dagoretti-north", createdAt: "2026-05-05T09:15:00Z", read: true,
    affectedInfra: ["Dagoretti North Fibre Ring", "Six-node dual-path backbone", "Digital Sovereignty sub-metric"],
    recommendedActions: [
  ...
  {
    id: "a19", severity: "medium", kind: "infra", title: "Embakasi North feeder energization gated by substation", body: "Feeder line poles, conductor stringing, and transformer bays are all complete. Energization cannot proceed until the Embakasi Substation grid-connection completes on the KPLC side — that milestone has slipped to July, pushing feeder energization to approximately August 2026.", zoneId: "embakasi-north", createdAt: "2026-05-12T14:00:00Z", read: false,
    affectedInfra: ["Embakasi North Feeder Line", "Embakasi Substation grid-connection", "Embakasi Central load redistribution"],
    recommendedActions: [
  ...
  {
    id: "a20", severity: "low", kind: "infra", title: "Embakasi West solar streetlight heads arrived", body: "The KEBS-certified solar streetlight heads and battery mounts for the Embakasi West rollout have arrived on site. Installation begins the first week of June, keeping the May 2026 commissioning window intact.", zoneId: "embakasi-west", createdAt: "2026-05-05T10:00:00Z", read: true,
    affectedInfra: ["Embakasi West Solar Streetlights", "480-pole solar array", "Ward street lighting coverage"],
    recommendedActions: [
...
export const REPORTS: Report[] = [
  ...
  },
  {
    ...
    executiveSummary: "Dagoretti North holds a healthy Vitality score of 72, anchored by strong infrastructure delivery and an emerging digital backbone. The Dagoretti North Fibre Ring (ICTA, KES 130M) is 47% complete, with duct and manhole works closed out and fibre blowing scheduled for early 2026. The ring is the county's first ward-scale digital-sovereignty asset outside the CBD and materially lifts the Safety pillar's Digital Sovereignty sub-metric.",
    sections: [
      { heading: "Project Milestone Status", content: "Route survey (Jun 2025): Complete\nDuct & manhole works (Oct 2025): Complete on schedule\nFibre blowing (Feb 2026): In progress\nNode activation (Jun 2026): On track" },
      { heading: "Digital Sovereignty Impact", content: "Once activated, the ring gives Dagoretti North six independent fibre nodes with dual-path redundancy. Projected uplift on the Digital Sovereignty sub-metric: +11 points. The ring also creates a physical alternative to the single CBD backhaul route, reducing systemic county-wide outage exposure." },
      { heading: "Coordination Notes", content: "Wayleave clashes with NCWSC water reticulation on the Ngong Road boundary have been resolved. No outstanding regulatory issues. ESIA on file with NEMA (approved Feb 2025)." },
      { heading: "Outlook", content: "Node activation remains on schedule for June 2026. Post-activation, Dagoretti North's Infrastructure pillar is projected to climb to 70+ by end of Q3, keeping the zone in the upper quartile." },
    ],
  },
  {
    id: "r12",
  ...
  },
  {
    ...
    executiveSummary: "The Roysambu Solar Microgrid (KPLC, KES 240M) is 55% complete and on track for April 2026 go-live. The project is Nairobi's first ward-scale islanded microgrid — a proof-point for solar-plus-storage resilience in peri-urban zones. Roysambu's Infrastructure pillar rose 4 points this quarter on the strength of installation progress.",
    sections: [
      { heading: "Delivery Snapshot", content: "Site survey (May 2025): Complete\n180 kW panel array installation (Sep 2025): Complete\n420 kWh battery storage (Jan 2026): In procurement, delivery scheduled for August\nGo-live (Apr 2026): On track pending battery arrival" },
      { heading: "Resilience Value", content: "The microgrid is sized to island Roysambu's essential services (health post, community water pump, streetlights) for 8-10 hours during unplanned KPLC outages. Given Nairobi's average 3.1 outages/month, this materially reduces expected downtime for services the community depends on." },
      { heading: "Cost & Financing", content: "Total budget: KES 240M. Expenditure to date: KES 132M (55%). Remaining committed: KES 108M, dominated by the battery bank at KES 84M. No cost overrun anticipated." },
      { heading: "Replication Potential", content: "The microgrid design is intended as a replicable template. Kasarani and Embakasi West have been shortlisted as second-wave candidates. A brief methodology hand-off is planned once Roysambu is commissioned." },
    ],
  },
  {
    id: "r14",
    ...
    executiveSummary: "Thika Road Smart Lighting (KPLC, KES 340M) is 45% complete but the installation corridor is flagged as high-risk in the county safety corridor mapping (Report r6, corridor 5). Copper theft from installed but un-energized poles has driven a 12% wastage rate. This study proposes accelerated commissioning and physical-security measures to protect the remaining installation phases.",
    sections: [
      { heading: "Project Status", content: "Contract signed (Apr 2025): Complete\nPole installation (Aug 2025): Complete — 620 poles erected\nWiring phase (Dec 2025): In progress, 45% overall\nCommissioning (Feb 2026): Sequential energization as wiring completes" },
      { heading: "Safety Corridor Interaction", content: "The Thika Road corridor is corridor 5 in the county safety-corridor mapping. Between February and May 2026 there were 14 reported copper-wiring theft incidents along the un-energized poles, resulting in KES 8.4M of material replacement. Overnight security is now the pacing constraint on wiring speed." },
      { heading: "Recommendations", content: "1. Sequence wiring + energization on the same night wherever possible — energized cabling is a lower-value theft target.\n2. Deploy anti-theft locking clamps at every pole base before wiring resumes.\n3. Coordinate with NPS for nightly patrols along the corridor during the wiring phase.\n4. Publish updated corridor-risk overlay in the Atlas Safety layer once field data confirms." },
      { heading: "Outlook", content: "If security controls hold, project remains on track for Feb 2026 commissioning window. Kasarani's Safety pillar is expected to gain 3-4 points post-commissioning as the corridor lights come on." },
    ],
  },
  {
    id: "r15",
    ...
    executiveSummary: "The Ruaraka Bypass Rehabilitation (KURA, KES 420M) is 53% complete with drainage works closed out. The bypass is the main relief route for Thika Road congestion and its rehabilitation is one of the largest single density interventions Ruaraka has seen. The Density & Scaling pillar is projected to gain 5-7 points at handover.",
    sections: [
      { heading: "Milestone Status", content: "Mobilization (May 2025): Complete\nCulvert & drainage works (Sep 2025): Complete\nBase & binder course (Jan 2026): In progress\nAsphalt overlay (May 2026): Scheduled\nHandover (Jul 2026): On track" },
      { heading: "Density & Friction Impact", content: "The bypass currently carries 22,000 vehicles/day. Post-rehabilitation projection is 34,000/day at improved average speeds, offloading Thika Road by an estimated 18% during peak hours. Ruaraka's Urban Friction Index is expected to drop from 42 to 34 at handover." },
      { heading: "Compliance", content: "ESIA on file with NEMA. Dust and noise controls in place; complaints from Baba Dogo residential clusters addressed via restricted working-hours agreement. No outstanding compliance issues." },
      { heading: "Outlook", content: "Handover remains on track for July 2026. Ruaraka's Vitality score (currently 66) is projected to climb to 70+ once the bypass is operational and Thika Road congestion eases." },
    ],
  },
  {
    id: "r16",
  ...
  },
  {
    ...
    executiveSummary: "The Embakasi North Feeder Line (KPLC, KES 280M) is 64% complete with poles, conductor stringing, and transformer bays closed out. Energization is scheduled for April 2026 but is contingent on the Embakasi Substation grid-connection milestone (Report r10). Both projects are now paired in the county infrastructure programme.",
    sections: [
      { heading: "Milestone Status", content: "Design & wayleave (Mar 2025): Complete\nPole & conductor stringing (Jul 2025): Complete\nTransformer bays (Dec 2025): Complete\nEnergization (Apr 2026): Gated by Embakasi substation KPLC connection" },
      { heading: "Substation Dependency", content: "The feeder cannot energize until the Embakasi substation grid-connection completes on the KPLC side. That milestone has slipped to July 2026 (Report r10), pushing feeder energization to approximately August 2026." },
      { heading: "Load Redistribution", content: "Once energized, the feeder is expected to reduce Embakasi Central's ~4.2 unplanned outages/month by roughly half via redundant load paths. It also creates headroom for the Roysambu Solar Microgrid to backfeed at low load hours." },
      { heading: "Outlook", content: "Embakasi North's Infrastructure pillar is projected to gain 4-6 points at energization. Vitality score (currently 62) is expected to climb into the mid-60s by end of Q3 2026." },
    ],
  },
  {
    id: "r18",
    ...
    executiveSummary: "The Jogoo Road Corridor Upgrade (KURA, KES 360M) has been stalled at 31% for over a month over a utility-relocation dispute with a fibre operator (Alert a12). Non-motorized transport lanes and carriageway widening are both on hold. Without resolution in the next 30 days, Embakasi Central's density pillar is exposed and the county infrastructure committee should convene.",
    sections: [
      { heading: "What Stalled", content: "In April 2026 the contractor exposed a buried fibre run that was not disclosed in the pre-construction wayleave dossier. The fibre operator refuses to move the run at its own cost. KURA maintains the wayleave dossier is authoritative. The site has been idle since April 18." },
      { heading: "Exposure", content: "Site material and equipment sit unsecured on the corridor. Embakasi Central's Density pillar (currently 54) is projected to lose 3-5 points if the corridor remains disrupted through Q3. The stall also blocks the connection to Ruaraka Bypass rehabilitation as an eastern relief route." },
      { heading: "Recommended Actions", content: "1. Convene KURA, the fibre operator, and NCWSC within 14 days to resolve the wayleave dispute.\n2. Escalate to the county infrastructure committee if not resolved by June 15.\n3. Secure the idle site to prevent equipment and material loss.\n4. Publish a revised programme once responsibility for the fibre relocation is agreed." },
      { heading: "Outlook", content: "If resolution comes within the next 30 days, the March 2026 target slips 4-5 months to Q3 completion. Beyond that horizon, the project moves into a re-scoping conversation and Embakasi Central's Infrastructure pillar carries a sustained drag." },
    ],
  },
  {
    id: "r19",
    ...
    executiveSummary: "Embakasi West Solar Streetlights (KPLC, KES 190M) is 49% complete with foundations and poles installed. Solar heads and battery mounts follow in the next quarter. The project targets 480 solar streetlight units across the ward and is expected to lift Safety pillar sub-metrics on street lighting coverage.",
    sections: [
      { heading: "Milestone Status", content: "Site audit & spacing plan (Jul 2025): Complete\nFoundation & pole erection (Nov 2025): Complete — 480 poles\nSolar head & battery mount (Feb 2026): In progress\nNetwork commissioning (May 2026): On track" },
      { heading: "Safety Impact", content: "Embakasi West's Safety pillar (currently 62) is projected to gain 3-5 points at commissioning as street lighting coverage moves from 24% to roughly 71% of the ward road network. Nighttime patrol reach is expected to widen correspondingly." },
      { heading: "Cost & Quality", content: "Total budget: KES 190M. Solar heads sourced from a KEBS-certified supplier. Battery warranty: 5 years with an on-site replacement stock of 24 units for early-life failure cover." },
      { heading: "Outlook", content: "Commissioning remains on schedule for May 2026. Once online, Embakasi West is expected to be the first Nairobi ward with majority solar-lit street coverage." },
    ],
  },
  {
    id: "r20",
    ...
    executiveSummary: "The Makadara Smart Grid Pilot (KETRACO, KES 310M) is 67% complete. Meter procurement and installation phases 1 and 2 are closed out; full deployment is scheduled for March 2026. The pilot is the county's largest AMI rollout to date and is intended as the template for county-wide smart-grid extension.",
    sections: [
      { heading: "Meter Rollout Progress", content: "Meter procurement (Feb 2025): Complete — 4,800 units\nInstallation phase 1 (Jun 2025): Complete — 2,100 units live\nInstallation phase 2 (Nov 2025): Complete — 4,650 units total\nFull deployment (Mar 2026): On track for a 4,800-unit closeout" },
      { heading: "Operational Learnings", content: "Non-technical loss detection has improved 34% in the phase-1 zones (vs. baseline). Two firmware update cycles delivered without service interruption. Meter reading intervals reduced from 30 days to 15 minutes at feeder head-ends." },
      { heading: "Replication Notes", content: "This deployment is the reference for the Embakasi and Kasarani smart-grid extensions in the 2026-2028 pipeline. A methodology hand-off is planned for Q3 2026 once the Makadara deployment closes out." },
      { heading: "Outlook", content: "Makadara's Infrastructure pillar (currently 68) is projected to gain 4-6 points at full deployment. County-wide smart-grid coverage crosses the 10% threshold once Makadara closes, up from 3% at the start of the pilot." },
    ],
  },
  {
    id: "r21",
    ...
    executiveSummary: "Kamukunji has the county's second-lowest Vitality score (57), pulled down primarily by the Safety pillar (52). The Eastleigh Fibre Backbone (ICTA, KES 160M, 40% complete) runs through corridor 3 in the county safety-corridor mapping — petty crime rate along the trenching path is 2.4x the county average. This report reads the delivery risk against the corridor exposure and proposes joint safety-plus-infrastructure interventions.",
    sections: [
      { heading: "Project Status", content: "Route survey (Jun 2025): Complete\nTrenching (Oct 2025): Complete\nFibre laying (Feb 2026): In progress along the Eastleigh section\nActivation (May 2026): Contingent on completed physical security" },
      { heading: "Corridor Exposure", content: "The Eastleigh section overlaps with a documented petty-crime corridor. Fibre-blowing crews have reported four incidents of tool theft and one of harassment during nightwork. Delivery pace has dropped to roughly 60% of plan along the corridor." },
      { heading: "Joint Safety-Infrastructure Recommendations", content: "1. Escort night crews with NPS presence during the fibre-blowing phase.\n2. Prioritize activating already-installed nodes in the lower-risk sections first — activation deters vandalism.\n3. Pair the ICTA rollout with a small solar-lighting scope along the trenching path (2 km).\n4. Coordinate with community leadership through the Kamukunji ward-level forum." },
      { heading: "Outlook", content: "If crew-security controls hold, activation slips to July 2026 (from May). Kamukunji's Safety pillar is projected to gain 4 points once the corridor is lit and the fibre nodes are live." },
    ],
  },
  {
    id: "r22",
    ...
    executiveSummary: "The Inner Ring Resurfacing (KURA, KES 180M) has been stalled at 34% for 45+ days. KURA issued a show-cause notice on May 10 (Alert a1) and the contractor has not remobilized. This escalation note recommends activating the penalty clause and starting the replacement-contractor process to preserve the November 2025 handover window — already slipped to Q2 2026 in practice.",
    sections: [
      { heading: "What Happened", content: "The contractor completed milling in May 2025 and demobilized without notice. Site plant has sat idle since. Overlay works — the largest remaining scope — have not begun. KURA's show-cause notice expired on May 20 with no substantive response." },
      { heading: "Contractual Position", content: "Section 12.3 of the contract permits penalty activation after 30 days of un-notified stoppage. That threshold was crossed on April 25. Section 14 permits termination-for-default after 60 days — that threshold is late June 2026. A replacement contractor shortlist should be pre-qualified before then." },
      { heading: "Recommended Actions", content: "1. Activate Section 12.3 penalty clause immediately.\n2. Pre-qualify three replacement contractors within 21 days.\n3. Notify affected CBD-access commuters via county channels of extended disruption.\n4. Secure the idle site to prevent plant and material loss.\n5. Flag Starehe's Infrastructure pillar as at-risk in the Q2 report cycle." },
      { heading: "Vitality Exposure", content: "Starehe's Infrastructure pillar is exposed to a 5-8 point drop in Q3 if the site remains idle through the long rains. Vitality score (currently 69) is projected to fall to the mid-60s without intervention. Under a replacement-contractor scenario, recovery is possible by Q4 2026." },
    ],
  },
];
...
export const ACTIVITIES: Record<string, ActivityEntry[]> = {
  ...
  ruaraka: [
    ...
    { id: "act29", zoneId: "ruaraka", kind: "road", text: "Bypass base and binder course works two weeks ahead of plan", source: "KURA", createdAt: "2026-05-06T08:30:00Z" },
    { id: "act30", zoneId: "ruaraka", kind: "road", text: "Baba Dogo residential noise-complaint agreement extended", source: "KURA", createdAt: "2026-04-25T11:00:00Z" },
  ],
  "dagoretti-north": [
    ...
    { id: "act21", zoneId: "dagoretti-north", kind: "grid", text: "Fibre-blowing phase commenced on the six-node backbone", source: "ICTA", createdAt: "2026-05-05T09:15:00Z" },
    { id: "act22", zoneId: "dagoretti-north", kind: "density", text: "Ngong Road boundary wayleave clash with NCWSC resolved", source: "KURA", createdAt: "2026-04-28T14:00:00Z" },
  ],
  roysambu: [
    { id: "act23", zoneId: "roysambu", kind: "grid", text: "180 kW solar panel array installation completed", source: "KPLC", createdAt: "2026-05-11T10:00:00Z" },
    { id: "act24", zoneId: "roysambu", kind: "grid", text: "Battery bank delivery slipped from January to August", source: "KPLC", createdAt: "2026-05-11T09:00:00Z" },
    { id: "act25", zoneId: "roysambu", kind: "esia", text: "Microgrid ESIA quarterly monitoring report filed with NEMA", source: "NEMA", createdAt: "2026-04-30T15:00:00Z" },
  ],
  kasarani: [
    { id: "act26", zoneId: "kasarani", kind: "grid", text: "620 poles erected across the Thika Road corridor", source: "KPLC", createdAt: "2026-05-16T11:30:00Z" },
    { id: "act27", zoneId: "kasarani", kind: "grid", text: "Copper-wiring theft cluster reached 14 incidents since February", source: "KPLC", createdAt: "2026-05-16T13:15:00Z" },
    { id: "act28", zoneId: "kasarani", kind: "grid", text: "Anti-theft locking clamps ordered for pole bases", source: "KPLC", createdAt: "2026-05-14T09:00:00Z" },
  ],
  langata: [
    { id: "act31", zoneId: "langata", kind: "road", text: "Langata Road base course phase closed out", source: "KeNHA", createdAt: "2026-05-02T10:00:00Z" },
    { id: "act32", zoneId: "langata", kind: "road", text: "Asphalt procurement locked at KES 186M via framework contract", source: "KeNHA", createdAt: "2026-04-22T14:30:00Z" },
    { id: "act33", zoneId: "langata", kind: "esia", text: "Quarterly ESIA monitoring report submitted to NEMA", source: "NEMA", createdAt: "2026-04-10T09:30:00Z" },
  ],
  makadara: [
    { id: "act34", zoneId: "makadara", kind: "grid", text: "AMI phase 2 installation closed out at 4,650 meters live", source: "KETRACO", createdAt: "2026-05-08T10:30:00Z" },
    { id: "act35", zoneId: "makadara", kind: "grid", text: "Non-technical loss detection improved 34% in phase-1 zones", source: "KETRACO", createdAt: "2026-05-02T11:00:00Z" },
    { id: "act36", zoneId: "makadara", kind: "grid", text: "Feeder head-end telemetry now reporting at 15-minute intervals", source: "KETRACO", createdAt: "2026-04-20T09:00:00Z" },
  ],
  kamukunji: [
    { id: "act37", zoneId: "kamukunji", kind: "grid", text: "Fibre-blowing phase started on the Eastleigh section", source: "ICTA", createdAt: "2026-05-15T09:00:00Z" },
    { id: "act38", zoneId: "kamukunji", kind: "grid", text: "Tool-theft incident reported on the Eastleigh trench nightwork", source: "ICTA", createdAt: "2026-05-15T22:40:00Z" },
    { id: "act39", zoneId: "kamukunji", kind: "grid", text: "NPS coordination request filed for corridor 3 night patrols", source: "ICTA", createdAt: "2026-05-16T10:15:00Z" },
  ],
  "embakasi-north": [
    { id: "act40", zoneId: "embakasi-north", kind: "grid", text: "Transformer bays completed on the feeder line", source: "KPLC", createdAt: "2026-05-10T12:00:00Z" },
    { id: "act41", zoneId: "embakasi-north", kind: "grid", text: "Energization gated by the Embakasi substation KPLC connection", source: "KPLC", createdAt: "2026-05-12T14:00:00Z" },
  ],
  "embakasi-central": [
    { id: "act42", zoneId: "embakasi-central", kind: "road", text: "Jogoo Road corridor idle at 31% for over a month", source: "KURA", createdAt: "2026-05-22T09:00:00Z" },
    { id: "act43", zoneId: "embakasi-central", kind: "road", text: "Fibre-operator wayleave dispute unresolved after 30 days", source: "KURA", createdAt: "2026-05-16T10:20:00Z" },
    { id: "act44", zoneId: "embakasi-central", kind: "road", text: "Idle-site security patrols escalated to daily", source: "KURA", createdAt: "2026-05-10T15:30:00Z" },
  ],
  "embakasi-west": [
    { id: "act45", zoneId: "embakasi-west", kind: "grid", text: "Solar heads and battery mounts delivered to site", source: "KPLC", createdAt: "2026-05-05T10:00:00Z" },
    { id: "act46", zoneId: "embakasi-west", kind: "grid", text: "480-pole foundation and erection phase closed out", source: "KPLC", createdAt: "2026-04-28T09:30:00Z" },
  ],
};
