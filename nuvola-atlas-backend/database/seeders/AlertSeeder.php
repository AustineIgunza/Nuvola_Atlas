...
class AlertSeeder extends Seeder
{
    public function run(): void
    {
        $alerts = [
            ...
            ['id' => 'a2', 'severity' => 'medium', 'kind' => 'vitality', 'title' => 'Kibra water score dropped 4 pts', 'body' => 'Water & Sanitation for Kibra fell from 56 to 52 in the latest WASREB IMPACT reporting round.', 'zone_id' => 'kibra', 'created_at' => '2026-05-18 14:00:00', 'read' => false],
